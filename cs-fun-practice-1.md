...
def print_array(array_of_ints)
  if array_of_ints.length == 0
    return "[]"
  end

  array_string = "["
  array_of_ints.length.times do |x|
    array_string += "#{x}, "
  end
  array_string = array_string[0..-3]
  array_string += "]"
...
puts print_array([1, 2, 3])
puts print_array([1, 2, 3, 4, 5, 6])
...
def stretch(array_of_ints)
  new_array = []
  array_of_ints.length.times do |x|
    new_array << array_of_ints[x] / 2
    new_array << array_of_ints[x] / 2 + array_of_ints[x] % 2
  end

  return new_array
end

print stretch([1, 2, 3, 4, 5])
...
def numUnique(sorted_array_of_ints)
  if sorted_array_of_ints.length == 0
    return 0
  end

  storage_hash = {}
  sorted_array_of_ints.length.times do |x|
    if storage_hash.keys.include? sorted_array_of_ints[x]
      storage_hash[sorted_array_of_ints[x]] += 1
    else
      storage_hash[sorted_array_of_ints[x]] = 1
    end
  end

  return storage_hash.keys.length
end

puts numUnique([])
puts numUnique([5, 7, 7, 7, 8, 22, 22, 23, 31, 35, 35, 40, 40, 40, 41])
puts numUnique([1, 2, 11, 17, 19, 20, 23, 24, 25, 26, 31, 34, 37, 40, 41])
...
def numUnique2(sorted_array_of_ints)
  if sorted_array_of_ints.length == 0
    return 0
  end
  ...
  total = 0
  sorted_array_of_ints.length.times do |x|
    if sorted_array_of_ints[x-1] != sorted_array_of_ints[x]
      total += 1
    end
  end
...
puts numUnique2([])
puts numUnique2([5, 7, 7, 7, 8, 22, 22, 23, 31, 35, 35, 40, 40, 40, 41])
puts numUnique2([1, 2, 11, 17, 19, 20, 23, 24, 25, 26, 31, 34, 37, 40, 41])
puts numUnique2([1, 2, 11, 17, 19, 20, 23, 24, 25, 26, 31, 34, 37, 40, 41, 41])
