...
describe 'stretch' do
  it 'Should return an array twice as long as the parameter' do
    inputs = [[], [1], [1, 2, 3]]
  ...
  it 'Should split an odd number and put bigger half first' do
    inputs = [[1], [3], [13], [99]]
  ...
  it 'Should correctly split a large array' do
    input = [18, 7, 4, 24, 11]
